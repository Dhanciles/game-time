class GamePiece {
  ...
  isCollidingWithTrail (trails) {
    ...
    if (this.color == 'red' && (this.coordinateCheck(yellowTrail) 
      || this.coordinateCheck(redTrail))) {
      return this.player1win; 
    } else if (this.color == 'yellow' && (this.coordinateCheck(redTrail) 
      || this.coordinateCheck(yellowTrail))) {
